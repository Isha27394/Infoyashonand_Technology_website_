...
// Main blog image
import blogImg from "../../assets/images/portfolio/Buisness/EG-3.png";
...
<section style={hero}>
  ...
  <div style={heroContent} className="hero-text-fix">
    ...
    <p style={{ fontSize: "15px" }}>
      ...
      &nbsp; / &nbsp;
      <span style={{ color: "#ffba00" }}>Expert Guruji App Blog</span>
    </p>
  </div>
</section>
      ...
      <div style={container}>
        <div style={{ width: "70%" }}>
          ...
          <div style={leftCol}>
            ...
            <h3 style={titleStyle}>
              How Expert Guruji App is Revolutionizing School Management
            </h3>

            <p style={excerpt}>
           Discover how Expert Guruji App simplifies attendance, fee management, communication, and more.
            </p>
            ...
            <div style={quoteBox}>
              <strong>
               "Expert Guruji App enhances efficiency and organization, allowing schools to focus on delivering quality education."
              </strong>
              <div style={{ marginTop: "8px" }}>
               With features for generating certificates, bonafide letters, and student ID cards, Expert Guruji App offers a seamless experience in handling essential documentation and communications.
              </div>
            </div>

            <p style={excerpt}>Its user-friendly interface and robust functionality help schools maintain organized records, ensure efficient workflow, and enhance communication between students, teachers, and parents. The app is designed to optimize school operations, reduce manual paperwork, and provide real-time updates to all stakeholders</p>
