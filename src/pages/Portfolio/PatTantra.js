      ...
      >
        ...
        <div style={{ flex: "1", minWidth: "350px" }}>
          ...
          <p style={{ lineHeight: "1.7", color: "#444" }}>
           PatTantra App is an intelligent business and financial management solution designed to give organizations complete control over their daily operations. It centralizes data, transactions, performance tracking, and reporting into one secure and easy-to-use platform.
          </p>

          <p style={{ lineHeight: "1.7", color: "#444" }}>
           Built with a focus on accuracy, security, and efficiency, PatTantra App helps businesses streamline workflows, reduce manual errors, and make smarter decisions using real-time insights and analytics.

          </p>

          <p style={{ lineHeight: "1.7", color: "#444" }}>
           With a clean user interface, secure data management, and scalable architecture, PatTantra App empowers business owners and teams to manage operations confidently, track growth, and maintain transparency across all processes.
          </p>
        </div>
      </div>
