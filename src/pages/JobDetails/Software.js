    ...
    <>
      ...
      <style>
        {`
          ...
          /* Mobile card fixes */
       /* Mobile card overflow full fix */
@media (max-width: 768px) {
  .job-left-content > div {
    width: 100% !important;
    max-width: 100% !important;
    padding: 15px !important;   /* fix padding */
...
>
  ...
  <div style={cardStyle}>
    <Section title="Job Description">
      <p>
        We are looking for a talented Senior Software<br></br> Engineer with 0-2 years of experience to join our <br></br>dynamic team. In this role, you will be responsible for designing, developing, and implementing software solutions that meet business requirements while<br></br> adhering to best practices in coding and architecture.
      </p>
      <p>
        As a Senior Software Engineer at InfoYashonand Technology, you will work on challenging projects, <br></br>mentor junior team members, and contribute to architectural decisions. You'll have the opportunity to work with cutting-edge technologies and be part of a collaborative environment that fosters innovation and professional growth.
      </p>
    </Section>
  </div>
  ...
  <div style={cardStyle}>
    <Section title="Responsibilities">
      <ul style={ulStyle}>
        ...
        <li>Write clean, scalable, and well-documented <br></br>code following best practices</li>
  ...
  <div style={cardStyle}>
    <Section title="Preferred Skills">
      <ul style={ulStyle}>
        ...
        <li>Knowledge of containerization and <br></br>orchestration tools (Docker, Kubernetes)</li>
  ...
  <div style={cardStyle}>
    <Section title="What We Offer">
      <ul style={ulStyle}>
        ...
        <li>Opportunity to work on challenging projects <br></br>with cutting-edge technologies</li>
