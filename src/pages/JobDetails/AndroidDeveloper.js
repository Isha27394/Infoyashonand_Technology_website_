...
>
  ...
  <div style={cardStyle}>
    <Section title="Job Description">
      <p>
        We are looking for an enthusiastic Android Developer with 0-2 years of experience to join our mobile development team.
      </p>
      <p>
        As an Android Developer at InfoYashonand Technology, you will work on developing new features...
      </p>
    </Section>
  </div>
  ...
  <div style={cardStyle}>
    <Section title="Responsibilities">
      <ul style={ulStyle}>
        ...
        <li>Unit-test code for robustness</li>
  ...
  <div style={cardStyle}>
    <Section title="Requirements">
      <ul style={ulStyle}>
        <li>0–2 years Android development experience</li>
        <li>Strong knowledge of Android SDK</li>
        <li>RESTful APIs knowledge</li>
        <li>Android UI design principles</li>
        <li>Offline storage & threading</li>
        <li>Open-source Android libraries familiarity</li>
        <li>Push notifications understanding</li>
        <li>Git knowledge</li>
      </ul>
    </Section>
  </div>
