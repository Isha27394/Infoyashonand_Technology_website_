...
>
  ...
  <div style={cardStyle}>
    <Section title="Job Description">
      <p>
        We are looking for a skilled UI-Ux Developer with 0-2 years of experience to join our
        dynamic team...
      </p>
      <p>
        As a UI-Ux Developer at InfoYashonand Technology, you will collaborate...
      </p>
    </Section>
  </div>
  ...
  <div style={cardStyle}>
    <Section title="What We Offer">
      <ul style={ulStyle}>
        ...
        <li>Diverse project exposure</li>
        <li>Career growth</li>
        <li>Mentorship</li>
      </ul>
    </Section>
