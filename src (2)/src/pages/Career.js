...
export default function Career() {
  ...
  return (
    <>
      ...
      <section style={{ padding: "80px 20px", background: "#f4f6fa" }}>
        <div
          style={{
            maxWidth: "1200px",
            margin: "0 auto",
        ...
        >
          <div style={{ flex: "1", minWidth: "320px" }}>
            ...
            >
              At InfoYashonand Technology, we believe our people are our greatest asset.
            ...
            >
              Join passionate technologists shaping the future of IT solutions in
      ...
      {/* ---------- WHY JOIN US ---------- */}
      <section style={{ ...section, background: "#f8f9fc" }}>
        <div style={container}>
