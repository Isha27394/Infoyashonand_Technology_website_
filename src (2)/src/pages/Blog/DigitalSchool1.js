...
// Main blog image
import blogImg from "../../assets/images/portfolio/Buisness/Digi-4.png";
      ...
      <section style={hero}>
        ...
        <div style={heroContent}>
          ...
          <p style={{ fontSize: "15px" }}>
            ...
            &nbsp; / &nbsp;
            <span style={{ color: "#ffba00" }}>Digital School Cloud App Blog</span>
          </p>
        </div>
      </section>
      ...
      <div style={container}>
        <div style={{ width: "70%" }}>
          ...
          <div style={leftCol}>
            ...
            <h3 style={titleStyle}>
            How Digital School is Revolutionizing Education Management
            </h3>

            <p style={excerpt}>
          Digital School is a comprehensive cloud-based school management software designed to streamline and automate daily administrative tasks. The platform centralizes student information, attendance, academic records, fee collection, timetable scheduling, and communication, ensuring a seamless flow of operations
            </p>

            <p style={excerpt}>
             With its intuitive interface and robust security measures, Digital School empowers administrators, teachers, and parents to access real-time data and collaborate efficiently. The software enhances transparency and efficiency, helping schools create an optimized learning environment for students.
            </p>

            <div style={quoteBox}>
              <strong>
               "Digital transformation in education is key to better management and enhanced learning experiences. Digital School is the perfect partner for modern educational institutions."
              </strong>
              <div style={{ marginTop: "8px" }}>
                By implementing Digital School, institutions can enhance efficiency, reduce paperwork, and improve communication between teachers, students, and parents—all while ensuring smooth administrative operations.
              </div>
            </div>

            <p style={excerpt}>The user-friendly interface, real-time data access, and automated management features make Digital School an essential tool for educational institutions looking to modernize their operations.</p>

            <div style={tagsStyle}>
              <div style={tag}>Education Technology</div>
              <div style={tag}> School Management</div>
              <div style={tag}>Student Records</div>
            </div>
          </div>
