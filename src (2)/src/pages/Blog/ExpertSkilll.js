...
// Main blog image
import blogImg from "../../assets/images/portfolio/Buisness/ES-1.png";
      ...
      <section style={hero}>
        ...
        <div style={heroContent}>
          ...
          <p style={{ fontSize: "15px" }}>
            ...
            &nbsp; / &nbsp;
            <span style={{ color: "#ffba00" }}>Expert Skill App Blog</span>
          </p>
        </div>
      </section>
      ...
      <div style={container}>
        <div style={{ width: "70%" }}>
          ...
          <div style={leftCol}>
            ...
            <h3 style={titleStyle}>
           How Expert Skill App is Transforming Online Learning
            </h3>

            <p style={excerpt}>
              Expert Skill App offers high-quality courses in English speaking, computer skills, and Android development to boost your career. With its intuitive interface and industry-expert-led courses, the platform ensures a seamless learning experience.
            </p>

            <p style={excerpt}>
             The app provides a dynamic learning environment through recorded video lessons, interactive quizzes, and practical projects. Users can learn at their own pace while mastering fundamental and advanced techniques in various skill domains. Whether you want to improve communication skills, develop technical expertise, or explore new career opportunities, Expert Skill App has a course tailored for you.
            </p>

            <div style={quoteBox}>
              <strong>
               "Unlock your potential with Expert Skill App – your gateway to professional growth and success."
              </strong>
              <div style={{ marginTop: "8px" }}>
                With Expert Skill App, learners gain access to structured courses, real-world projects, and skill certification, making them job-ready in competitive industries. The user-friendly design ensures a smooth learning experience for beginners and professionals alike.
              </div>
            </div>

            <p style={excerpt}>Additionally, the app's comprehensive curriculum, expert guidance, and flexible learning approach make it a must-have platform for anyone looking to upskill efficiently. Enhance your learning experience with high-quality resources and track your progress with in-app tools.</p>

            <div style={tagsStyle}>
              <div style={tag}>Online Learning</div>
              <div style={tag}> Skill Developmentt</div>
              <div style={tag}>Career Growth</div>
            </div>
          </div>
