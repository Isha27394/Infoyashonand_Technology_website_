...
// Main blog image
import blogImg from "../../assets/images/portfolio/Buisness/E-1.png";
      ...
      <section style={hero}>
        ...
        <div style={heroContent}>
          ...
          <p style={{ fontSize: "15px" }}>
            ...
            &nbsp; / &nbsp;
            <span style={{ color: "#ffba00" }}>E-Salary Management Blog</span>
          </p>
        </div>
      </section>
      ...
      <div style={container}>
        <div style={{ width: "70%" }}>
          ...
          <div style={leftCol}>
            ...
            <h3 style={titleStyle}>
              Streamlining HR with e Salary: Efficient Attendance and Payroll Management
            </h3>

            <p style={excerpt}>
             e Salary is a comprehensive app designed to streamline employee attendance tracking and payroll management. With its intuitive interface, the app allows employees to easily clock in and out, while providing managers with real-time attendance data and advanced reporting tools.
            </p>

            <p style={excerpt}>
              Integrated payroll automation simplifies salary calculations, deductions, and bonus allocations, reducing manual errors and administrative overhead. e Salary ensures secure, reliable data management through cloud-based storage and advanced security protocols, making it an ideal solution for modern HR departments looking to optimize workforce management and improve operational efficiency.
            </p>

            <div style={quoteBox}>
              <strong>
                “Efficient HR management is key to unlocking organizational success.”
              </strong>
              <div style={{ marginTop: "8px" }}>
                By leveraging e Salary, companies can enhance their HR operations, reduce costs associated with manual processes, and improve employee satisfaction through transparent and timely payroll management.
              </div>
            </div>

            <p style={excerpt}>Moreover, the app's user-friendly interface and robust features make it easy for both employees and managers to navigate, ensuring a smooth transition from traditional methods to a more modern, digital approach.</p>

            <div style={tagsStyle}>
              <div style={tag}>HR Technology</div>
              <div style={tag}>Payroll Management</div>
              <div style={tag}>Attendance Tracking</div>
            </div>
          </div>
