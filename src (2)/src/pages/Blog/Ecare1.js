...
// Main blog image
import blogImg from "../../assets/images/portfolio/Buisness/H-3.png";
...
export default function Ecare1() {
      ...
      <section style={hero}>
        ...
        <div style={heroContent}>
          ...
          <p style={{ fontSize: "15px" }}>
            ...
            &nbsp; / &nbsp;
            <span style={{ color: "#ffba00" }}>E-care360 App Blog</span>
          </p>
        </div>
      </section>
      ...
      <div style={container}>
        <div style={{ width: "70%" }}>
          ...
          <div style={leftCol}>
            ...
            <p style={excerpt}>
            E-Care360 is a comprehensive hospital management software that centralizes essential operations such as patient registration, medical records, billing, and inventory management, enhancing efficiency and patient care.</p>

            <p style={excerpt}>
              With cloud-based storage, real-time analytics, and automation, E-Care360 simplifies appointment scheduling, pharmacy management, and lab integrations, reducing administrative overhead while improving operational efficiency.
            </p>

            <div style={quoteBox}>
              <strong>
                "A well-integrated hospital management system is the backbone of efficient healthcare. E-Care360 is transforming the way hospitals operate, ensuring better patient outcomes and seamless workflows."
              </strong>
              <div style={{ marginTop: "8px" }}>
                Hospitals leveraging E-Care360 can streamline workflows, enhance regulatory compliance, and provide better healthcare services with ease.</div>
            </div>

            <p style={excerpt}>The user-friendly interface ensures smooth navigation for healthcare professionals, reducing manual errors and allowing them to focus more on patient care rather than administrative tasks.</p>

            <div style={tagsStyle}>
              <div style={tag}>Healthcare Technology</div>
              <div style={tag}> Hospital Management</div>
              <div style={tag}>Medical Software</div>
            </div>
          </div>
