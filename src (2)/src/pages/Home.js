...
import eSalary from "../assets/images/portfolio/E-salaryApp2.png";
import patTantra from "../assets/images/portfolio/patTantra2.png";
import eCare360 from "../assets/images/portfolio/Ecare3601.png";
import scrollerApp from "../assets/images/portfolio/Scroller1.png";
import dhaara from "../assets/images/portfolio/Dhaara1.png";
import expertGuruji from "../assets/images/portfolio/Buisness/EG-4.png";
import constructIQ from "../assets/images/portfolio/ConstructIQ1.png";
import digitalSchool from "../assets/images/portfolio/DigitalSchool1.png";
import kamDhanda from "../assets/images/portfolio/KamDhanda1.png";
import expertSkill from "../assets/images/portfolio/ExpertSkill1.png";
import marketingPro from "../assets/images/portfolio/marketingpro2.png";
import matrimonialApp from "../assets/images/portfolio/matrimonial1.png";
// ---- Import Images ----
...
import shubhamImg from "../assets/images/Rehan1.jpg";
...
const handleSubmit = (e) => {
  ...
  const clientWebsites = [
    ...
    "https://apexfinancialservices.in/",
     "https://www.udaanindia.com/career",
  ...
  const portfolioData = [
  { name: "E-Salary", category: "Business", img: eSalary, detailsLink: "/Portfolio/e-salary" },
  { name: "PatTantra", category: "Finance", img: patTantra, detailsLink: "/Portfolio/pattantra" },
  { name: "E-Care360", category: "Healthcare", img: eCare360, detailsLink: "/Portfolio/ecare360" },
  { name: "Scroller App", category: "Education", img: scrollerApp, detailsLink: "/Portfolio/scroller" },
  { name: "Dhaara", category: "Business", img: dhaara, detailsLink: "/Portfolio/dhaara" },
  { name: "Expert Guruji", category: "Education", img: expertGuruji, detailsLink: "/Portfolio/expert-guruji" },
  { name: "ConstructIQ", category: "Business", img: constructIQ, detailsLink: "/Portfolio/constructiq" },
  { name: "Digital School Cloud", category: "Education", img: digitalSchool, detailsLink: "/Portfolio/digital-school" },
  { name: "KamDhanda", category: "Business", img: kamDhanda, detailsLink: "/Portfolio/kamdhanda" },
  { name: "Expert Skill", category: "Business", img: expertSkill, detailsLink: "/Portfolio/expert-skill" },
  { name: "Marketing Pro", category: "Business", img: marketingPro, detailsLink: "/Portfolio/marketing-pro" },
  { name: "Matrimonial App", category: "Business", img: matrimonialApp, detailsLink: "/Portfolio/matrimonial" },
  ];
  ...
  },
{
 ...
 { name: "Isha Gaikwad", role: "Web Developer", img: ishaImg },
...

  {
    ...
    members: [
       { name: "Ramehwar Shinde", role: "Android Developer", img: RamImg },
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Right Side - Text */}
        <div style={{ flex: "1", minWidth: "300px" }}>
          <h2 style={{ fontWeight: "700", fontSize: "30px", fontStyle: "times new roman" }}>
            <b>
          ...
          >
            Looking for the best software company in Sangli? Look no further
            than Infoyashonand Technology<br /> Pvt. Ltd., your trusted partner for
            IT infrastructure services in Sangli. We specialize in managed IT
            services, <br />enterprise IT solutions, technical support services, and
            IT staffing solutions to ensure seamless business operations.
            As a reliable IT services provider in Maharashtra, we offer IT
            deployment & support, cloud solutions, and scalable IT services
            for startups, SMEs, and enterprises. We help businesses grow with
            efficient, modern IT solutions. Partner with us—the leading
            software development company in Sangli—and take your business to
            the next level with cutting-edge technology. 🚀 Contact us today!
          </p>
...
>
  ...
  >
    {[
      ...
      { number: 50, label: "Certified Professionals", icon: <FaGraduationCap size={38} color="darkorange" /> },
      ...
      >
        ...
        <h2 style={{ margin: 0, color: "black", fontSize: "32px" }}>
          <CountUp
            start={0}
            end={stat.number}
            duration={2.5}
...
>
  ...
  >
    {[client1, client2, client3, client4, client5, client6, client7, client8, client9].map(
      (logo, index) => (
        <img
          key={index}
          src={logo}
          ...
          onClick={() => window.open(clientWebsites[index], "_blank")}
          style={{
            width: "180px",
            height: "160px",
            objectFit: "contain",
...
>
  ...
  >
    {[
      { title: "Software Development", text: "Software development is the process of creating, designing, coding, testing, and maintaining software systems that fulfill specific user or business requirements...", icon: <FiMonitor size={36} color="darkorange" /> },
      { title: "Web Development", text: "Web development refers to the creation and maintenance of websites or web applications, combining various technologies to deliver engaging and functional digital experiences...", icon: <FiSmartphone size={36} color="darkorange" /> },
      { title: "Android Development", text: "Android development focuses on creating software applications for devices running the Android operating system, including smartphones, tablets, smart TVs, wearables, and automotive systems...", icon: <FaAndroid size={36} color="darkorange" /> },
      { title: "Digital Marketing", text: "Digital marketing leverages online channels to connect businesses with their target audiences. It includes techniques such as SEO, SEM, social media marketing, and email campaigns...", icon: <FiTrendingUp size={36} color="darkorange" /> },
      { title: "SEO (Search Engine Optimization)", text: "SEO is a specialized area of digital marketing aimed at improving website visibility in search engine results. Optimizing for relevant keywords increases traffic, credibility, and conversions.", icon: <FaSearch size={36} color="darkorange" /> },
      { title: "Training and Job Consultant", text: "These initiatives help individuals secure tech jobs by offering resume optimization, interview preparation, networking strategies, and educational programs to enhance skills...", icon: <FaGraduationCap size={36} color="darkorange" /> },
      { title: "Official WhatsApp API", text: "With its global reach, advanced automation capabilities, and secure messaging environment, the WhatsApp Business API is essential for enhancing digital presence and customer satisfaction.", icon: <FaWhatsapp size={36} color="darkorange" /> },
      { title: "Voice Call Services", text: "Voice call services utilize VoIP technology to deliver high-quality voice communication over the internet, streamlining call management processes for businesses.", icon: <FaPhone size={36} color="darkorange" /> },
      { title: "Bulk SMS API", text: "Bulk SMS APIs allow businesses to integrate SMS functionality into existing platforms, enabling automated large-scale messaging campaigns efficiently.", icon: <FaSms size={36} color="darkorange" /> },
      { title: "Lead Generation", text: "Lead generation services identify and engage potential customers through targeted campaigns, SEO optimization, and analytics, converting them into loyal customers.", icon: <FiUsers size={36} color="darkorange" /> },
      ...
      <div
        ...
        onClick={(e) => {
          ...
          for (let card of allCards) card.style.border = "2px solid transparent";
      ...
      >
        ...
        <p style={{ color: "#444", lineHeight: "1.6" }}>{serviceItem.text}</p>
      </div>
    ))}
  </div>
</section>
...
{/* Gallery Section */}
<section id="gallery" style={{ padding: "80px 20px", background: "#f5f5f5" }}>
  <div
    style={{
      maxWidth: "1200px",
      margin: "0 auto 50px auto",
      textAlign: "left", // Align heading to left
    }}
  >
    {/* Small heading */}
    <h4
  ...
  <div
    style={{
      display: "grid",
      gridTemplateColumns: "repeat(3, 1fr)", // exactly 3 images per row
      gap: "100px",
      maxWidth: "1200px",
      margin: "0 auto",
    }}
