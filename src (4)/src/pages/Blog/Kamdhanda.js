...
// Main blog image
import blogImg from "../../assets/images/portfolio/Buisness/Kam-1.png";
    ...
    <div style={page}>
      ...
      <section style={hero}>
        ...
        <div style={heroContent}>
          ...
          <p style={{ fontSize: "15px" }}>
            ...
            &nbsp; / &nbsp;
            <span style={{ color: "#ffba00" }}>KamDhaanda Appp Blog</span>
          </p>
        </div>
      </section>
      ...
      <div style={container}>
        <div style={{ width: "70%" }}>
          {/* MAIN BLOG CARD */}
          <div style={leftCol}>
            <img src={blogImg} alt="kamdhanda" style={bigImageStyle} />

            <h3 style={titleStyle}>
              How Kamdhanda is Empowering Resellers & Business Owners
            </h3>

            <p style={excerpt}>
             Explore how Kamdhanda simplifies business marketing, e-commerce, and job search—all in one powerful app.
            </p>

            <p style={excerpt}>
            Kamdhanda is a versatile Android app designed to empower resellers and business owners with a one-stop solution for business marketing, e-commerce, and job search. The app provides robust tools for promoting products and services, managing online sales, and reaching new markets—all from a single, user-friendly platform.

<br></br>Additionally, Kamdhanda simplifies talent acquisition by offering integrated job search and posting features, allowing businesses to find the right candidates while giving job seekers access to exciting opportunities.
            </p>

            <div style={quoteBox}>
              <strong>
               "A powerful tool for entrepreneurs, Kamdhanda bridges the gap between business growth and workforce expansion."
              </strong>
            ...
            <p style={excerpt}>With its user-friendly design and comprehensive features, Kamdhanda ensures that businesses of all sizes can leverage digital transformation to stay ahead in a competitive market.</p>

            <div style={tagsStyle}>
              <div style={tag}>Business Growth</div>
              <div style={tag}>E-commerce</div>
              <div style={tag}>Job Search</div>
            </div>
          </div>
