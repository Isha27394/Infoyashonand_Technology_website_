...
const styles = {
  ...
  breadcrumbSection: { backgroundColor: '#ffffff', borderBottom: '1px solid #e0e0e0', padding: '15px 0' },
  breadcrumbContainer: { maxWidth: '1200px', margin: '0 auto', padding: '0 20px', display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '8px' },
  breadcrumbLink: { color: '#667eea', textDecoration: 'none', fontSize: '0.95rem', transition: 'color 0.3s ease', fontWeight: '500' },
  breadcrumbActive: { color: '#333', textDecoration: 'none', fontSize: '0.95rem', fontWeight: '600', cursor: 'default' },
  breadcrumbSeparator: { color: 'darkorange', fontSize: '1.2rem', fontWeight: 'bold', margin: '0 5px' },
